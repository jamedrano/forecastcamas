...
if uploaded_ingresos_file is not None and uploaded_egresos_file is not None:
    ...
    # --- Landing page instructions when no data is uploaded ---
    st.markdown("""
    ...
    **To begin, please upload your data files using the sidebar on the left.**
    ...
    # The broken image link has been REMOVED from here.

# --- Footer ---
# This is placed at the end of the script to ensure it appears at the bottom of the sidebar.
st.sidebar.divider()
st.sidebar.markdown(
